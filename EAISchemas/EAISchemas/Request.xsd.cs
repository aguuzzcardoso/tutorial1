namespace EAISchemas {
    ...
    [Schema(@"http://EAISchemas.Schema1",@"Request")]
    [Microsoft.XLANGs.BaseTypes.PropertyAttribute(typeof(global::EAISchemas.PropertySchema.GrandTotal), XPath = @"/*[local-name()='Request' and namespace-uri()='http://EAISchemas.Schema1']/*[local-name()='Header' and namespace-uri()='']/*[local-name()='GrandTotal' and namespace-uri()='']", XsdType = @"decimal")]
