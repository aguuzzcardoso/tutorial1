...
<xsl:stylesheet xmlns:xsl=""http://www.w3.org/1999/XSL/Transform"" xmlns:msxsl=""urn:schemas-microsoft-com:xslt"" xmlns:var=""http://schemas.microsoft.com/BizTalk/2003/var"" exclude-result-prefixes=""msxsl var s0"" version=""1.0"" xmlns:s0=""http://EAISchemas.Schema1"" xmlns:ns0=""http://EAISchemas.Schema2"">
  ...
  <xsl:template match=""/s0:Request"">
    <ns0:DeclineReq>
      ...
      <GrandTotal>
        <xsl:value-of select=""Header/GrandTotal"" />
      </GrandTotal>
    </ns0:DeclineReq>
  </xsl:template>
</xsl:stylesheet>";
